...
Then using the precomputed hashes of the \inlinehaskell{MerkleTree}, a \texttt{Map} of intermediate results can easily be created by:
...
When there is a change in the \inlinehaskell{BinTree}, only a part of the node hashes needs to be rehashed.
