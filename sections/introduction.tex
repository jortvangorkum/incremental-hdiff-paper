...
An implementation of computing the max path sum over data type \inlinehaskell{BinTree} is and has a complexity of $\mathcal{O}(N)$, where $N$ is the number of nodes in the tree.
\begin{haskell}
...
\todo[inline]{Add a summary of what the Thesis is going to entail}
